        ...
        <div className="card-body p-5">
         ...
         <div className="d-flex align-items-center mb-4">
          ...
          <form>
           ...
           <button type="submit" className="btn btn-info w-100 py-2 mb-4 rounded d-flex justify-content-center align-items-center">
            Continue 
            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" className="ms-2" viewBox="0 0 16 16"><path fillRule="evenodd" d="M4.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L10.293 8 4.646 2.354a.5.5 0 0 1 0-.708z"/></svg>
          </button>
          </form>
